...
- **묶음 판매** — 일반 64개 / 은 8개 / 금 4개 단위로 거래
- **시장 붕괴** — 고가 구간에서 판매 시 확률적으로 가격 폭락, 6시간 후 자동 복구
- **세금 시스템** — 기본 세율 / 권한 보유자 감면 세율 지원
- **씨앗 상점** — 작물 씨앗 일괄 구매 지원
...
| 플러그인 | 용도 |
|----------|------|
| [Vault](https://www.spigotmc.org/resources/vault.34315/) | 경제 시스템 연동 |
| [ItemsAdder](https://www.spigotmc.org/resources/itemsadder.73355/) | 은·금 등급 커스텀 아이템 인식 |
| [MMOItems](https://www.spigotmc.org/resources/mmoitems-premium.39267/) | 일반 등급 커스텀 아이템 인식 |

---

## 설치 방법

1. 위 의존 플러그인을 모두 설치합니다.
